...
//
// DescriÁ„o:   Classe para reproduzir ·udio
//
**********************************************************************************/
...
Audio::Audio()
{
    ...
    {
        // cria o dispositivo principal de sa˙Åa de audio
...
Audio::~Audio()
{
    // deleta todos os sons da coleÁ„o
...
{ 
    ...
    // limpa voz corrente e inicia reproduÁ„o do som
    ...
    // seleciona nova trilha para reproduÁ„o do prÛximo som
...
{
    // verifica se o n˙ìel estÅEdentro dos limites
    if (level < 0)
        level = 0;
